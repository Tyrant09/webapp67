...
<body class="p-3 mb-2 bg-primary-subtle text-primary-emphasis">
    <div class="container mt-4">
        <h1 class="text-center mb-4">Actors Information</h1>
                    ...
                    if ($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            echo "<tr>
                                    ...
                                    <td>" . $row["AwardsCount"] . "</td>
                                    <td>
                                        <a href='editactor.php?ActorID=" . $row["ActorID"] . "' class='btn btn-sm btn-warning'>Edit</a>
                                    </td>
                                  </tr>";
                        }
                    } else {
        ...
        <div class="text-center mt-4">
            <a href='insertactor.php' class='btn btn-primary'>Insert New Actor</a>
        </div>
